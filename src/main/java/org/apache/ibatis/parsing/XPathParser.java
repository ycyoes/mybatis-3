...
public class XPathParser {
  ...
  public List<XNode> evalNodes(Object root, String expression) {
    ...
    // <2> 封装成 XNode 数组, 最终结果会将 Node 封装成 org.apache.ibatis.parsing.XNode 对象，主要为了动态值的替换。
  ...
  public XNode evalNode(Object root, String expression) {
    ...
    // <2> 封装成 XNode 对象， 最终结果会将 Node 封装成 org.apache.ibatis.parsing.XNode 对象，主要为了动态值的替换。
